...
//los cuales posteriormente será sustituidos por el parametro respectivo
        ...
        private final String SQL_UPDATE = "UPDATE persona SET nombre_persona=?, edad_persona=?,telefono_persona=?, sexo_persona=?, id_ocupacion=?, fecha_nac=? WHEREid_persona=?";
        private final String SQL_DELETE = "DELETE FROM persona WHERE id_persona = ?";
        private final String SQL_SELECT = "SELECT p.id_persona,p.nombre_persona , p.edad_persona, p.telefono_persona ," + "p.sexo_persona, o.ocupacion, p.fecha_nac " + "FROM persona p INNER JOIN ocupaciones o ON p.id_ocupacion = o.id_ocupacion ";
