...
//Metodo para ingresar valores
            ingreso();
            s.executeUpdate("Insert into persona values("+id+",\""+nombre+"\","+edad+",\""+telefono+"\",\""+sexo+"\","+idocupaci on+",\""+fechanac+"\")");
...
//Error SQL: login/passwdó sentencia sql erronea
    ...
    public void ingreso() throws SQLException {
        ...
        sexo = (String) JOptionPane.showInputDialog(null, "¿Ingrese el sexo?",
